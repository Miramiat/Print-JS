...
function updateSlide() {
    ...
    dotSelected.forEach(function(dot) {
        dot.style.backgroundColor = "";
    });
    
    // Définir la couleur du point correspondant à l'image courante en noir
    dotSelected[currentSlide].style.backgroundColor = "black";
...
dotSelected.forEach(function(dot, index) {
